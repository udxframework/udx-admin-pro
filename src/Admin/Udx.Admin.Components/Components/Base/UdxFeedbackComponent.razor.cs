...
{
    public partial class UdxFeedbackComponent<TComponentOptions, TResult> : FeedbackComponent<TComponentOptions, TResult>, IHandleEvent
    {
        ...
        [Inject]
        IConfigCacheService  ConfigCacheService { get; set; }
